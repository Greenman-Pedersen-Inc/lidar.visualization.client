...
export class Profile extends THREE.Object3D {
    constructor() {
        ...
        this.lineColor = new THREE.Color(0x00ffff);
    }
    ...
    addMarker(point) {
...

        {
            // event listeners
            let drag = (e) => {
                let I = Utils.getMousePointCloudIntersection(e.drag.end, e.viewer.scene.getActiveCamera(), e.viewer, e.viewer.scene.pointclouds);
